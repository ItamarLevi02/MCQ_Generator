...
# CALLING API 
client = ChatOpenAI(openai_api_key=api_key, model="gpt-4o-mini",temperature=0.5)
...
TEMPLATE2="""
You are an expert teacher at {subject}. Given a Multiple Choice Quiz for {subject} students.\
